...
export type Board={id:string;name:string;pattern:string;patternColor:string;surface:string;gap:number;sort:number;image:string;imageFit:string;nodeScale:number;visibility:string;proposalAudience:string};
