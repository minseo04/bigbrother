...
export type Article = { id: string; title: string; url: string; source: string; published: string; entities: string[]; };
export type Source = { id: string; name: string; url: string; feed: string; status?: string; count?: number; checked?: string };
export type Briefing = { date: string; articles: Article[]; sources: Source[]; updated: string; };
